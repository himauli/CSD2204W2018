...
INSERT INTO `custom` VALUES (1,'Himauli','himauli@gmail.com',60000.00,'bronze'),(2,'Foram','foram@gmail.com',510000.00,'silver'),(3,'Harsh','harsh@gmail.com',60000.00,'bronze');
...
DELIMITER ;;
/*!50003 CREATE OR REPLACE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger `trigg_cust`
...
INSERT INTO `emp_details` VALUES (100,'STEVEN','KING','STEVEN.KING@GMAIL.COM','2345678','1998-01-14','AD_PRES',24000.00,0.10),(101,'NEENA','KOCHHAR','NEENA.KOCHHAR@GMAIL.COM','2345678','2002-10-10','AD_VP',17000.00,0.50),(102,'LEX','DE HANN','LEX.HANN@GMAIL.COM','2345678','1995-10-20','AD_VP',17000.00,0.50),(103,'ALEXANDER','HUNOLD','ALEXANDER.HUNOLD@GMAIL.CO','2345678','2002-11-23','IT_PROG',9000.00,0.25),(104,'BRUCE','ERNST','BRUCE.ERNST@GMAIL.COM','2345678','2003-08-24','IT_PROG',6000.00,0.25),(105,'DAVID','AUSTIN','DAVID.AUSTIN@GMAIL.COM','2345678','2005-04-10','IT_PROG',4800.00,0.25);
...
INSERT INTO `number` VALUES (0.48),(0.01),(0.60),(10.60),(0.99),(0.12),(0.62);
...
INSERT INTO `products` VALUES (1,'Hard drive',240,5),(2,'Memory',120,6),(3,'ZIP drive',150,4),(4,'Floppy disk',5,6),(5,'Monitor',240,1),(6,'DVD drive',180,2),(7,'CD drive',90,2),(8,'Printer',270,3),(9,'keyboard',66,3),(10,'DVD burner',180,2),(11,'Printer',40,7),(12,'Toner cartridge',54,7),(13,'DVD burner',78,7);
...
INSERT INTO `stud_marks` VALUES (1,'ALEX',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'BOB',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'CHARLEY',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'DONNA',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `d10_v8` AS select `products`.`Code` AS `code`,`products`.`Name` AS `product`,`manu`.`Name` AS `manufecturer` from (`manu` join `products` on((`products`.`Code` = `manu`.`Code`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2018-01-24 11:30:27
