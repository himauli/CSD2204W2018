...
--
-- Temporary view structure for view `d10_v1`
--
...
/*!50001 CREATE VIEW `d10_v1` AS SELECT 
 1 AS `Code`,
 1 AS `Name`,
 1 AS `Price`,
 1 AS `Manufacturer`*/;
...
--
-- Temporary view structure for view `d10_v8`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `d10_v8` AS SELECT 
 1 AS `code`,
 1 AS `product`,
 1 AS `manufecturer`*/;
SET character_set_client = @saved_cs_client;
...
-- Dump completed on 2018-01-19 11:50:38
